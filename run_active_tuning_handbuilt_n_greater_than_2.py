...
def system_dynamics_step(state, u_t, W0, w_inh, params: SimParams):
    ...
    dw_dt_ct_1 = (
        ...
        * ((0 * jnp.outer(dx_dt[:n], x_ct_1) -  W[:n, :n] * jnp.outer(x_ct_1, dx_dt[:n]) - 0 * params.alpha * (z * z_hp * x_ct_1)[:, None]) + 1 * params.alpha * jnp.outer(z, x_ct_1))  # Changed to x_ct_1_filt
...
if __name__ == "__main__":
    ...
    # Save results
    with open('network_training_results_all_4.pkl', 'wb') as f:
