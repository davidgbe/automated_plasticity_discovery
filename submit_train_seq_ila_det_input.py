...
params = OrderedDict()
params['SEED'] = [str(k) for k in range(8000, 8010)]
params['PARAM_VEC'] = [
	...
	# '"-0.01" 0.01 0 0 0 0 2.5 7.5 0.01 10e-3 10e-3 2e-3 10e-3 10e-3 2e-3 1 1 0 0 0 0 1 1 1',

	# # # w-STDP + summed weight bound
	# '"-0.001" 0.001 0 "-0.02" 0.02 0 1000 7.5 0.01 10e-3 10e-3 2e-3 10e-3 10e-3 2e-3 0 0 0 1 1 0 0 1 1',

	# # # # STDP + summed weight bound
	# '"-0.01" 0.01 0 0 0 0 1000 7.5 0.01 10e-3 10e-3 2e-3 10e-3 10e-3 2e-3 1 1 0 0 0 0 0 1 1',

	# # # # STDP + w-firing rate bound
	# '"-0.01" 0.01 0 0 0 "-0.005" 1000 1000 0 10e-3 10e-3 2e-3 10e-3 10e-3 2e-3 1 1 0 0 0 1 0 0 0',
 
 	# # STDP + firing rate bound
	# '"-0.01" 0.01 "-0.005" 0 0 0 1000 1000 0 10e-3 10e-3 2e-3 10e-3 10e-3 2e-3 1 1 1 0 0 0 0 0 0',

	# # # w-STDP + w-firing rate bound
	# '"-0.001" 0.001 0 "-0.02" 0.02 "-0.005" 1000 1000 0 10e-3 10e-3 2e-3 10e-3 10e-3 2e-3 0 0 0 1 1 1 0 0 0',
]
