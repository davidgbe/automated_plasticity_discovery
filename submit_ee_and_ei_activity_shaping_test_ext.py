...
base_path = os.curdir
scripts = [
	'submit_ee_and_ei_activity_shaping_test_ext.slurm',
]
...
params = OrderedDict()
params['SEED'] = [str(1)]
params['SYN_CHANGE_PROB'] = [0.003] #[0, 0.001, 0.0015, 0.002]
params['STDP_COEF'] = [0.02]
params['STDP_TAU'] = [5e-3]
params['FR_TAU'] = [1e-3]
params['W_IE'] = [1e-4]
params['CEE_COEF'] = [ 0.15e-2, 0.25e-2, 0.3e-2]
params['WIE_COEF'] = [0, 1e-2, 1.25e-2, 1.5e-2, 1.75e-2, 2e-2, 2.25e-2, 2.5e-2, 2.75e-2, 3e-2, 3.25e-2, 3.5e-2]
params['Y2_IE_COEF'] = [0, 1e-2, 1.25e-2, 1.5e-2, 1.75e-2, 2e-2, 2.25e-2, 2.5e-2, 2.75e-2, 3e-2, 3.25e-2, 3.5e-2]
