...
base_path = os.curdir
scripts = [
	'submit_moment_control_experimental.slurm',
]
...
params['EXC_RULE_RATE'] = [3e-2, 3e-2, 4e-2]
...
params['A_I'] = [0.5, 0.6]
params['T_I'] = [4e-3, 5e-3, 6e-3]
params['A_F'] = [0.5, 0.6]
params['T_F'] = [4e-3, 5e-3, 6e-3]
