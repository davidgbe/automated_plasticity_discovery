...
if __name__ == '__main__':
	...
	for file_name in file_names:
		...
		if mean_loss_non_drop < 150: # 80 for unperturbed
	...
	for k in range(N_TERMS_TO_FIT, N_TERMS_TO_FIT + 1):
		...
		out_dir = f'sims_out/refit_ee_unpert_median_{k}_terms_{BATCH_SIZE}_STD_EXPL_{STD_EXPL}_FIXED_{FIXED_DATA}_L1_PENALTY_{joined_l1}_CHANGEP_{CHANGE_PROB_PER_ITER}_FRACI_{FRAC_INPUTS_FIXED}_SEED_{SEED}_{time_stamp}'
		os.mkdir(out_dir)
