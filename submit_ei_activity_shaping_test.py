...
params = OrderedDict()
params['SEED'] = [str(i) for i in range(500, 501)]
params['W_EE'] = [str(i) for i in [0.1e-3, 0.15e-3, 0.2e-3, 0.25e-3, 0.3e-3, 0.35e-3, 0.4e-3]]
params['W_IE'] = [str(-i) for i in [0.1e-3, 0.15e-3, 0.2e-3, 0.25e-3, 0.3e-3, 0.35e-3, 0.4e-3]]
